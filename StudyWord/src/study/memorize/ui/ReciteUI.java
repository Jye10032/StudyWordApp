...
import study.memorize.managers.ReciteManager;
import study.memorize.managers.ReciteManager.Modes;
import study.memorize.models.Word;
...
public class ReciteUI extends JFrame implements KeyListener, ActionListener {
	...
	public ReciteUI() {
		...
		this.add(mainPanel);
		// 
		this.setTitle("Study Word");
		this.setSize(400, 400);
		this.setResizable(false);
		
		ImageIcon icon = new ImageIcon("./res/wordBook.png");
		...
		lblStatus.setText( "按\'`\'键跳过"+"    当前词库："+ reciteManager.getThesaurusName());
		nextWord();
	}
	...
	public void actionPerformed(ActionEvent event) {
		if (event.getSource() == chooseThItem) {
			...
			JOptionPane.showMessageDialog(this, "版权所有 高跃铭 贺婷 李蕙存 么保鑫 毕中东");
		}
	}
